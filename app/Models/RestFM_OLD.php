...
class RestFM_OLD extends Model
{
    ...
    public $layout = '';
    public $secure = true;
    public $token_name = '';//$_SESSION["fmtoken2"] = "ijshgfiwurfbqbqrlvhjrqiog";
    ...
    function __construct($host = HOST, $db = DB, $user = USER, $pass = PASS, $layout = LAYOUT, $token_name = "fmtoken1")
    {
        $this->host = $host;
        $this->db = $db;
        $this->user = $user;
